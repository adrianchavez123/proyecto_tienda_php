...
<?php
	...
	{
		if($proveedor->borrar($_POST['id']))
		{
			echo "<h2 class='error'>Borrado</h2>";
...
<fieldset style="margin:auto">
		 <legend>Baja proveedores</legend>
	<form id="form1" name="form1" method="post">
	<div>
	<label for="DardebajaProve">Dar de baja Proveedor nombre/razon</label>
	<select name='id'>
		<?php
