...
<?php
	...
	if(isset($_POST['id']) and !empty($_POST["id"])
		and isset($_POST['Nombre']) and !empty($_POST["Nombre"])
	...
	{
		if($proveedor->modificar($_POST['id'],$_POST['Nombre'],$_POST['Rfc'],$_POST['Domiciliop'],$_POST['Ciudad']))
		{
...
<fieldset style="margin:auto">
		 <legend>Modificar proveedores</legend>
	<form id="form1" name="form1" method="post">
	<div>
	<label for="ModificarProve">Modificar Proveedor Nombre/razon</label>
	<select name='id'>
		<?php
